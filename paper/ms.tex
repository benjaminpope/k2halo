...
\software{\textsc{k2sc} \citep{Aigrain2015,k2sc}; IPython  \citep{PER-GRA:2007}; SciPy \citep{scipy}; and Astropy, a community-developed core Python package for Astronomy \citep{astropy}.}
