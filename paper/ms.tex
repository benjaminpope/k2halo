...
Our dataset includes a rich variety of classical pulsators. We used visual inspection of the light curves and amplitude spectra to classify all non red-giant stars into traditional variability classes such as $\delta$ Scuti stars, $\gamma$ Doradus stars, slowly pulsating B~stars, $\beta$ Cephei pulsators, as well as supergiants showing stochastic variability \citep[][]{Aerts2018,bowman19}. The classes we have determined for each star are listed in Table~\ref{table_all}. A detailed frequency analysis of the variability in each star will be presented in a forthcoming paper (Greklek-McKeon et al., in prep).
